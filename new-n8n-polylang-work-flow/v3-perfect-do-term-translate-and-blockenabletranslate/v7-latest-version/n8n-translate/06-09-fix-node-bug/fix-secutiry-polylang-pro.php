...
// Custom secret key to bypass standard HTTP Basic Auth header stripping issues on some hostings (e.g. SiteGround).
if (!defined('PLT_SECRET')) {
    define('PLT_SECRET', 'your_secure_plt_secret_here');
}
